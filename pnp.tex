...
\pagestyle{fancy}
\newcommand{\myfooters}{
\rfoot{electronic mail\\ \url{mailto:justina@colmena.biz}}
\cfoot{\textbf{[\begin{NoHyper}Page\ \thepage\ of\ \pageref{LastPage}\end{NoHyper}]}}
\lfoot{justina colmena\\\today\ @\currenttime}
...
\newcommand{\Remark}{\raisebox{-0.125ex}{\large\Info}}
